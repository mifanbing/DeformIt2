...
rotatedLeftArmContour = util.rotateContour(poseLines[3], inputContourPointsRefine, -math.pi / 6, workImage, dataLoader.inputImageResize)
# for point in rotatedLeftArmContour:
#     ww, hh = point
#     workImage[hh, ww] = (0, 255, 255)
    
rotatedRightArmContour = util.rotateContour(poseLines[5], inputContourPointsRefine, math.pi / 6, workImage, dataLoader.inputImageResize)
# for point in rotatedRightArmContour:
#     ww, hh = point
#     workImage[hh, ww] = (0, 255, 255)
    
rotatedLeftLegContour = util.rotateContour(poseLines[8], inputContourPointsRefine, math.pi / 6, workImage, dataLoader.inputImageResize)
# for point in rotatedLeftLegContour:
#     ww, hh = point
#     workImage[hh, ww] = (0, 255, 255)
    
rotatedRightLegContour = util.rotateContour(poseLines[11], inputContourPointsRefine, -math.pi / 6, workImage, dataLoader.inputImageResize)
